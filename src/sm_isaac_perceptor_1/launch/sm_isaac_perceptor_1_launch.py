...
def generate_launch_description():
    ...
    # urdf = os.path.join(sm_isaac_perceptor_1_dir, "urdf", "turtlebot3_waffle.urdf")
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        # default_value=os.path.join(sm_isaac_perceptor_1_dir, "config", "sm_isaac_perceptor_1_navigation_params.yaml"),
        default_value=os.path.join(
            sm_isaac_perceptor_1_dir, "config", "rtx_carter_navigation_params.yaml"
        ),
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(sm_isaac_perceptor_1_dir, "config", "navigation_tree.xml"),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(sm_isaac_perceptor_1_dir, "rviz", "nav2_default_view.rviz"),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(
            sm_isaac_perceptor_1_dir, "maps", "improved_carter_warehouse_navigation.yaml"
        ),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_isaac_perceptor_1_launch_dir, "rviz_launch.py")),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_isaac_perceptor_1_launch_dir, "bringup_launch.py")),
    #     launch_arguments={
    #         "namespace": namespace,
    ...
    #     # PythonLaunchDescriptionSource(os.path.join(sm_isaac_perceptor_1_launch_dir, "carter_navigation.launch.py")),
    #     PythonLaunchDescriptionSource(
    #         os.path.join(sm_isaac_perceptor_1_launch_dir, "carter_navigation_rtx.launch.py")
    #     ),
    #     launch_arguments={
    #         "namespace": namespace,
    #         "use_namespace": use_namespace,
