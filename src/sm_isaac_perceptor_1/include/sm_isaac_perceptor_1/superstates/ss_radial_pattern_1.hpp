...
using namespace sm_isaac_perceptor_1::radial_motion_states;
...
public:
  ...
  // TRANSITION TABLE
  typedef mpl::list<
      Transition<EvLoopEnd<StiRadialLoopStart>, StStartExploration, ENDLOOP> //,
...
#include <sm_isaac_perceptor_1/states/radial_motion_states/sti_radial_end_point.hpp>
#include <sm_isaac_perceptor_1/states/radial_motion_states/sti_radial_loop_start.hpp>
#include <sm_isaac_perceptor_1/states/radial_motion_states/sti_radial_return.hpp>
#include <sm_isaac_perceptor_1/states/radial_motion_states/sti_radial_rotate.hpp>
} // namespace SS1
} // namespace sm_isaac_perceptor_1
